...
# To declare static array for storing the text to place
replaceTextArray=(
"temp"
"temp2"
)

# Check the sizes of findTextArray and replaceTextArray
if [ ${#findTextArray[@]} != ${#replaceTextArray[@]} ]
then
    echo "[Error] The sizes of findTextArray [${#findTextArray[@]}] and replaceTextArray [${#replaceTextArray[@]}] should be equal."
    exit 1
fi
